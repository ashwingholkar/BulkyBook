    ...
    public partial class newTableProducts : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 11, 25, 9, 29, 14, 299, DateTimeKind.Local).AddTicks(6314), 1, "Action" },
                    { 2, new DateTime(2023, 11, 25, 9, 29, 14, 299, DateTimeKind.Local).AddTicks(6326), 3, "Scifi" },
                    { 3, new DateTime(2023, 11, 25, 9, 29, 14, 299, DateTimeKind.Local).AddTicks(6327), 5, "History" }
                });
